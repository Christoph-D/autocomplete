...
suite("normalizeBackendProviders", () => {
  ...
  test("keeps a temperature override alongside other overrides on the same model", () => {
    const out = normalizeBackendProviders({
